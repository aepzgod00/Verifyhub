...
function getStats() {
  ...
  const s = { documents: 132, verified: 124, pending: 8, accuracy: 99.2 };
    ...
    <div>
      ...
      <main className="main">
        <div className="page-header">
          {/* ย้ายปุ่มกลับหน้าหลักมาอยู่ซ้ายมือสุดของหัวข้อหลัก */}
          <button className="btn-back" onClick={onBack} title="กลับหน้าหลัก">←</button>
        ...
        <button className="btn btn-primary btn-full btn-lg" disabled={!canRun} onClick={runAudit}
          style={{ borderRadius: "100px", marginTop: 12 }}>
  ...
  return (
    <div>
      ...
      <main className="main">
        ...
        <button className="btn btn-primary" style={{ borderRadius: "100px", padding: "11px 28px", marginTop: 4 }} onClick={saveDO}>
